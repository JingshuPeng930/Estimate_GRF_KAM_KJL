...
RAW_ROOT = Path(os.environ.get("RAW_DATA_ROOT", REPO_ROOT))
IMU_DIR = RAW_ROOT / "IMU_Data_Process" / "AB03_Amy" / "LG_Exo" / "IMU_CSV"
IMU_NOEXO_DIR = RAW_ROOT / "IMU_Data_Process" / "AB03_Amy" / "LG_NoExo" / "IMU_CSV"
KJL_DIR = RAW_ROOT / "KJL_GT" / "AB03_Amy"
OUT_ROOT = Path(os.environ.get("KJL_OUTPUT_ROOT", PACKAGE_ROOT / "data" / "kjl_ab03_dep"))
...
def main():
    ...
    exo_model_path = RAW_ROOT / "IMU_Data_Process" / SUBJECT / "LG_Exo" / "SCALE" / f"{SUBJECT}_Scaled_unilateral.osim"
    noexo_model_path = RAW_ROOT / "IMU_Data_Process" / SUBJECT / "LG_NoExo" / "SCALE" / f"{SUBJECT}_Scaled_unilateral.osim"
